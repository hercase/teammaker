...
const Logo: FC<LogoProps> = ({ size = "medium" }) => (
  ...
  >
    <path
      d={WORDMARK_PATH}
      /*
        The token, not fill-current. currentColor is inherited at paint time, and the share image is
        drawn from a detached clone of this node where there is nothing to inherit from, so the
        wordmark came out black on a dark background.
      */
